...
"""
    This module defines a class for  Method that tests the square module
"""


class test_square(unittest.TestCase):
    """
       defines a class for  Method that tests the square module Testing square
    """
    ...
    def test_width(self):
        """
            Method that tests the square width getter
        """
        self.assertEqual(5, self.testsq.width)

    def test_height(self):
        """
            Method that tests the square height getter
        """
        self.assertEqual(5, self.testsq.height)
    ...
    def test_x(self):
        ...
        self.testsq.x = 54
        self.assertEqual(54, self.testsq.x)
        self.assertEqual(0, self.testsq.y)
    ...
    def test_y(self):
        ...
        self.testsq.y = 45
        self.assertEqual(45, self.testsq.y)
        self.assertEqual(0, self.testsq.x)
    ...
    def test_x_string(self):
        """
            Method that tests the x attribute type validation
        """
        with self.assertRaises(TypeError):
            sq = Square(1, "46")
    ...
    def test_y_string(self):
        """
            Method that tests the attribute's type validation
        """
        with self.assertRaises(TypeError):
            sq = Square(1, 7, "46")
    ...
    def test_area(self):
        """
            Method that tests the area of the square
        """
        self.assertEqual(self.testsq.area(), 5 * 5)
        sq = Square(3, 8, 8, 2)
        self.assertEqual(sq.area(), 3 * 3)

    def test_str_overload(self):
        testsq = Square(5, 8, 7, 88)
        self.assertEqual(testsq.__str__(), "[Square] (88) 8/7 - 5")

    def test_update_id(self):
        """
            Method that tests the update method
        """
        self.testsq.update(54)
        self.assertEqual(54, self.testsq.id)

    def test_update_x(self):
        """
            Method that tests the update method
        """
        self.testsq.update(54, 30, 10)
        self.assertEqual(10, self.testsq.x)

    def test_update_y(self):
        """
            Method that tests the update method
        """
        self.testsq.update(54, 30, 6, 2)
        self.assertEqual(2, self.testsq.y)

    def test_update_dict(self):
        """
            Method that tests the update method with **kwargs
        """
        self.testsq.update(y=1, size=2, x=3, id=89)
        self.assertEqual(1, self.testsq.y)
        self.assertEqual(2, self.testsq.size)
        self.assertEqual(3, self.testsq.x)
        self.assertEqual(89, self.testsq.id)

    def test_update_dict_list(self):
        """
            Method that tests the update method with **kwargs and *args
        """
        self.testsq.update(1000, y=1, width=2, x=3, id=89)
        self.assertEqual(1000, self.testsq.id)

    def test_update_dict_no_key(self):
        """
            Method that tests the update method with **kwargs
        """
        self.testsq.update(y=1, size=2, xox=3, id=89)

    def test_to_dict(self):
        """
            Method that tests the type that is returned
            from the to_dictionary method
        """
        r1 = Square(5)
    ...
    def test_to_dict_print(self):
        """
            Method that tests the dict that will be printed
        """
        r1 = Square(5, 0, 0, 410)
    ...
    def test_missing_height(self):
        """
            Expecting a type error because height and width
            are missing
        """
        with self.assertRaises(TypeError):
            Square()
    ...
    def test_saving_to_file_no_iter(self):
        ...
        """
        with self.assertRaises(TypeError):
            Square.save_to_file(self.testsq)
    ...
    def test_saving_to_file_type(self):
        """
            Testing saving a file into json format and
            Method that tests the type
        """
        if os.path.exists("Square.json"):
            os.remove("Square.json")
        r1 = Square(5, 0, 0, 346)
    ...
    def test_json_string_type(self):
        """
            Method that tests the returned type
        """
        list_input = [
            {"id": 2089, "size": 10},
            {"id": 2712, "size": 1}]
    ...
    def test_load_from_file_not_the_same(self):
        """
            Method that tests if an object was created from the
    ...
    def test_display_square(self):
        """
            Method that tests stdout output by capturing it
        """
...
class TestSquare(unittest.TestCase):
    ...
    def test_wrong_inputted_values(self):
        ...
        with self.assertRaises(ValueError):
            testsq = Square(-4, -5)
        with self.assertRaises(ValueError):
            testsq = Square(1, 1, -2, -2)
        with self.assertRaises(TypeError):
            testsq = Square()
        with self.assertRaises(TypeError):
            testsq = Square(1, 2, 3, 4, 5, 6, 7)
    ...
    def test_inputted_types(self):
        ...
        """
        with self.assertRaises(TypeError):
            testsq = Square("width", "height")
        with self.assertRaises(TypeError):
            testsq = Square(2.4, 1.3)
        with self.assertRaises(TypeError):
            testsq = Square(1, 2, "x value", "y value")
        with self.assertRaises(TypeError):
            testsq = Square(1, 2, 2.4, 1.3)
        with self.assertRaises(TypeError):
            testsq = Square(True, False)
        with self.assertRaises(TypeError):
            testsq = Square(1, 2, True, False)
        with self.assertRaises(TypeError):
            testsq = Square([1, 1], 2, 3, 4)
        with self.assertRaises(TypeError):
            testsq = Square((1, 2), "x value", "y value")
        with self.assertRaises(TypeError):
            testsq = Square({1: 3, 2: 4}, 5, 6)
    ...
    def test_area(self):
        ...
        """
        testsq = Square(10, 10)
        self.assertEqual(testsq.area(), 100)
        with self.assertRaises(TypeError):
            A = testsq.area(1)
    ...
    def test_str(self):
        ...
        """
        testsq = Square(1, 2, 3, 4)
        self.assertEqual("[Square] (4) 2/3 - 1", str(testsq))
    ...
    def test_update_args(self):
        ...
        testsq = Square(1, 2, 3, 4)
        testsq.update(6)
        self.assertEqual(6, testsq.id)
        testsq.update(6, 7)
        self.assertEqual(7, testsq.size)
        testsq.update(6, 7, 8)
        self.assertEqual(8, testsq.x)
        testsq.update(6, 7, 8, 9)
        self.assertEqual(9, testsq.y)

    def test_display(self):
        """
        Test display method
        """
        testsq = Square(2, 0, 0, 4)
        with io.StringIO() as bufferIO, redirect_stdout(bufferIO):
            testsq.display()
            output = bufferIO.getvalue()
            self.assertEqual(output, ("#" * 2 + "\n") * 2)
        testsq = Square(2, 3, 4, 5)
        with io.StringIO() as bufferIO, redirect_stdout(bufferIO):
            testsq.display()
            output = bufferIO.getvalue()
    ...
    def test_update_kwargs(self):
        ...
        """
        testsq = Square(1, 2, 3, 4)
        testsq.update(6, id=7)
        self.assertEqual([testsq.id, testsq.size, testsq.x, testsq.y],
                         [6, 1, 2, 3])
        testsq.update(6, 7, x=9, y=10)
        self.assertEqual([testsq.id, testsq.size, testsq.x, testsq.y],
                         [6, 7, 2, 3])
        testsq.update(width=7, id=6, height=8)
        self.assertEqual([testsq.id, testsq.size, testsq.x, testsq.y],
                         [6, 7, 2, 3])
        testsq.update(x=40, y=5)
        self.assertEqual([testsq.id, testsq.size, testsq.x, testsq.y],
                         [6, 7, 40, 5])
    ...
    def test_dictionary(self):
        ...
        """
        testsq = Square(100, 300, 400, 500)
        S_dict = testsq.to_dictionary()
...
class TestSquare(unittest.TestCase):
    ...
    def test_11_1(self):
        ...
        with self.assertRaises(TypeError) as x:
            testsq = Square("Hello", 2)
        self.assertEqual("width must be an integer", str(x.exception))
        with self.assertRaises(TypeError) as x:
            testsq = Square(2, "World")
        self.assertEqual("x must be an integer", str(x.exception))
        with self.assertRaises(TypeError) as x:
            testsq = Square(1, 2, "Foo", 3)
